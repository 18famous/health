...
<head>
    ...
    <link rel="stylesheet" href="crtaccnt.css">
</head>
        ...
        <form name="f1" method="post">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                alert('Please enter a valid e-mail');
                    ...
                    echo "<script>
                alert('Password should be a combination of letters and numbers and should be min 8 characters with atleast 1 uppercase letter');
            </script>";
                } else {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        echo "<script>
                alert('Entered email already exists in our systems');
            </script>";
                    } else {
                        ...
                        if (!mysqli_query($conn, $query)) {
                            ...
                            echo "<script>
                alert('Successfully Signed up! Your email is your username');
